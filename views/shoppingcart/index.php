                        ...
                        <tbody>
                            <?php foreach($cart['buy'] as $value): ?>
                                <tr class="table_cart__item">
                                    ...
                                    <td style="width: 200px;">
                                        <ul class="table_cart__info">
                                            ...
                                            <li class="table_cart__row-info">
                                                ...
                                                <input class="input-quantity btn btn-light" type="text" name="quantity" value="<?= isset($value['quantity']) ? $value['quantity'] : 0 ?>" min="1" max="100">
                                            </li>
                                            <li class="table_cart__row-info">
                                    ...
                                    <td style="width: 200px;">
                                        <div action="" method="post" class="d-flex justify-content-end align-items-center">
